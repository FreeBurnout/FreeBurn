...
namespace Gt2dRenderer {
	...
	static void SetClipRegion(const CGtV2d&, const CGtV2d&);
	static void SetTextureAddressMode(EGt2dRendererTexAddress);
	static void SetTextureFilterMode(EGt2dRendererFilter);
	static void SetTexture(CGtTexture*);
