...
#include "../Game/Progression/BoSignatureTakedowns.h"
#include "../Camera/BoPlayerCameraManager.h"
#include "../../../SharedClasses/BoAILaneStruct.h"
...
enum class EGameDataDifficulty {
...
public:
	...
	EBoSignatureTakedownType GetSignatureTakedownType(GtMathPC::CGtV3d lTakedownPosition);
